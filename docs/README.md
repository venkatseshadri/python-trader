...
### 🚀 Roadmaps & Future Projects
- **[Future Ideas](./future/IDEAS.md)**: Small incremental tweaks and minor features.
- **[Remote Control & Monitoring](./future/REMOTE_MONITORING.md)**: Design for PM2 and Telegram integration.
- **[Supabase Migration](./future/SUPABASE_MIGRATION.md)**: Plan for Cloud-Native database and UI.
- **[Cloud Migration Roadmap](./CLOUD_MIGRATION.md)**: General infrastructure migration plan.
- **[Raspberry Pi Setup](../install/rpi/RASPI_SETUP.md)**: Guide for bare-metal ARM deployment.
