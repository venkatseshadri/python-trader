...
class MediumDefenseEngine(UltraDefenseEngine):
    def run_simulation(self, stock_data_dict):
        ...
        for i in range(45, max_len):
            ...
            for name, pos in self.active_positions.items():
                ...
                exit_hit = False
                # 🛡️ MEDIUM FAST BRAKE (1m LTP vs 5m EMA9)
                e9_5m = row['ema9_5m']
                ...
                if not exit_hit and pos['max_pnl_rs'] >= 1000: # Increased to 1000 for breathing room
...
def generate_medium_matrix():
    ...
    engine = MediumDefenseEngine(top_n=5)
    ...
    df_matrix.to_html("python-trader/backtest_lab/reports/medium_defense_matrix.html")
    print(f"✅ Medium Matrix generated: python-trader/backtest_lab/reports/medium_defense_matrix.html")

if __name__ == "__main__":
    generate_medium_matrix()
