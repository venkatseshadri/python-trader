...
class TestBrokerFacade(unittest.TestCase):
    ...
    def test_scrip_master_parsing(self):
        ...
        master = ScripMaster(self.client.project_root)
    ...
    def test_token_resolution_logic(self):
        ...
        master.equity_manager.SYMBOL_TO_TOKEN['SBIN-EQ'] = '12345'
        
        # Should resolve via equity manager
        self.assertEqual(master.get_equity_token('SBIN-EQ'), '12345')
